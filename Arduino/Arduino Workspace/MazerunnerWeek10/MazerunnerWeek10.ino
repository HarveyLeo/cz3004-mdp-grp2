...
void moveForward(int distance){
  ...
  while(1){
                  ...
                  output = pidControlForward(left_encoder_val,right_encoder_val,pwmR,pwmL);
...
int rotateLeft(int angle){
  ...
  while(1){
    ...
    output = pidControlLR(left_encoder_val,right_encoder_val,pwm1,pwm2);
...
MDP10                                    PID Control
---------------------------------------------------------------------------------------------------*/
int pidControlForward(int left_encoder_val, int right_encoder_val,int pwm1, int pwm2) {
  int error,prevError;
...
//MDP 10.1
int pidControlLR(int left_encoder_val, int right_encoder_val,int pwm1, int pwm2) {
  int error,prevError;
  float integral,derivative,output;
  float kp = 1;
  float ki = 1;
