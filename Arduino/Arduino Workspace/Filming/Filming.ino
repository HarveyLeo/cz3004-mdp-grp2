...
void moveForward(int distance) {
  ...
  switch (distance) {
    ...
    case 2: multiplier = 540; break;
    case 3: multiplier = 555; break;
    case 4: multiplier = 565; break;
    case 5: multiplier = 575; break;
    case 6: multiplier = 575; break;
    case 7: multiplier = 580; break;
    case 8: multiplier = 580; break;
    case 9: multiplier = 585; break;
    case 10: multiplier = 585; break;
    case 11: multiplier = 585; break;
    case 12: multiplier = 585; break;
    case 13: multiplier = 585; break;
    case 14: multiplier = 585; break;
    case 15: multiplier = 585; break;
    case 16: multiplier = 585; break;
    case 17: multiplier = 585; break;
    default: multiplier = 585; break;
...
int rotateLeft(int angle) {
  ...
  if (angle <= 15) {
    ...
    else angle_offset = angle * 9.24;            //9.33 When all fully charged, pid speed 200, no usb 5V
  }
...
void angleAlign() {
  while (1) {
    ...
    int error = LFreading - (RFreading-10);//Higher to the left, Lower to the right
